...
#   Reads C:\blueteam_ir\EVIDENCE.log (collected by ir_monitor.ps1)
...
#   Check if evidence exists:  Get-Content C:\blueteam_ir\EVIDENCE.log
#
# HOW TO USE:
...
#            C:\blueteam_ir\IR_REPORT_<timestamp>.txt
#
...
#                      soffice --headless --convert-to pdf C:\blueteam_ir\IR_REPORT_*.txt
#
