...
#            .\harden_windows.ps1
#
#   Step 4 - When prompted, enter your team's new password. Review the output.
#            The log is saved to $env:USERPROFILE\blueteam_logs\harden_<timestamp>.log
#
...
$LogFile = "$env:USERPROFILE\blueteam_logs\harden_$(Get-Date -Format 'yyyyMMdd_HHmmss').log"
...
$NewPass = Read-Host -Prompt "[?] Enter new password for all accounts" -AsSecureString
