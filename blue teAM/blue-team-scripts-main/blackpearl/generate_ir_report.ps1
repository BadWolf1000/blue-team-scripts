...
#   Reads $env:USERPROFILE\blueteam_logs\EVIDENCE.log (collected by ir_monitor.ps1)
...
#   Check if evidence exists:  Get-Content $env:USERPROFILE\blueteam_logs\EVIDENCE.log
#
# HOW TO USE:
...
#            $env:USERPROFILE\blueteam_logs\IR_REPORT_<timestamp>.txt
#
...
#                      soffice --headless --convert-to pdf $env:USERPROFILE\blueteam_logs\IR_REPORT_*.txt
#
#   Step 5 - Upload the PDF to Discord before the inject deadline.
#
# OUTPUT: $env:USERPROFILE\blueteam_logs\IR_REPORT_<timestamp>.txt
# ============================================================
