...
#            Get-Content $env:USERPROFILE\Desktop\blueteam_logs\watchdog.log
#
...
#
# LOG FILE: $env:USERPROFILE\Desktop\blueteam_logs\watchdog.log
# ============================================================

$LogFile = "$env:USERPROFILE\Desktop\blueteam_logs\watchdog.log"
$Interval = 30  # seconds
