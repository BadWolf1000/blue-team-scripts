...
#   to $env:USERPROFILE\Desktop\blueteam_logs\EVIDENCE.log. Each event is tagged so
...
#            Get-Content $env:USERPROFILE\Desktop\blueteam_logs\EVIDENCE.log
#            or search for a specific IP:
#            Select-String "10.x.x.x" $env:USERPROFILE\Desktop\blueteam_logs\EVIDENCE.log
#
...
#      from minute one.
#
# LOG FILES (all in $env:USERPROFILE\Desktop\blueteam_logs\):
